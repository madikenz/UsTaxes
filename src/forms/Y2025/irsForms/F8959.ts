...
export default class F8959 extends F1040Attachment {
  ...
  isNeeded = (): boolean => {
    ...
    const totalW2Income = this.f1040
      .validW2s()
  ...
  l3 = (): number | undefined => this.f1040.f8919?.totalWages()
  ...
  l14 = (): number | undefined => this.f1040.info.rrtaCompensation
  ...
  // RRTA Tier 1 tax withheld (from railroad W-2 equivalent)
  l23 = (): number | undefined => this.f1040.info.rrtaTax ?? 0
