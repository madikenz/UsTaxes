...
export default class F8995A extends F8995 {
  ...
  l4b = (): number | undefined => ifNumber(this.l2b(), () => 0)
  l4c = (): number | undefined => ifNumber(this.l2c(), () => 0)
  ...
  l7b = (): number | undefined => ifNumber(this.l2b(), () => 0)
  l7c = (): number | undefined => ifNumber(this.l2c(), () => 0)

  l8a = (): number | undefined => ifNumber(this.l7a(), (num) => num * 0.25)
  l8b = (): number | undefined => ifNumber(this.l7b(), (num) => num * 0.25)
  l8c = (): number | undefined => ifNumber(this.l7c(), (num) => num * 0.25)
