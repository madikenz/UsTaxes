...
export default class StudentLoanInterestWorksheet {
  ...
  // TY2025: MFJ $175,000 / Others $85,000
  l5 = (): number =>
    this.f1040.info.taxPayer.filingStatus === FilingStatus.MFJ ? 175000 : 85000

  l6 = (): number => Math.max(0, this.l4() - this.l5())

  // MFJ phaseout range is $30,000; all others $15,000
  private phaseOutRange = (): number =>
